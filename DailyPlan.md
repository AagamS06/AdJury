...
- DoD: member cannot reach admin routes; unauth redirected; add a guard unit test.
...
### Day 8 — Submission UI
- [ ] `/review` submission form: content textarea, content-type + platform selects, client-side Zod validation, calls `/api/reviews`.
